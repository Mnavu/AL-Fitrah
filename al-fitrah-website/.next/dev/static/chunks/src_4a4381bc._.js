...
function Register() {
    ...
    const handleRegister = async (e)=>{
        ...
        setLoading(true);
        setMessage('');
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('registrations').insert([
            {
                name,
                email,
                course
...
_s(Register, "+LIaxvvV3fwxEpSEB42Wf/PhzsI=");
_c = Register;
var _c;
...
//# sourceMappingURL=src_4a4381bc._.js.map